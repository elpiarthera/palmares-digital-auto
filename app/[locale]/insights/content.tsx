...
const DimensionComparisonChart = dynamic(
  () => import("@/components/charts/comparison-chart").then((m) => m.DimensionComparisonChart),
  { ssr: false, loading: () => <div className="flex h-[300px] items-center justify-center text-muted-foreground text-sm">Loading chart...</div> }
);
